    ...
    return (
      ...
      <MDBRow className="mb-4">
        ...
        <MDBCol xl="3" md="6" className="mb-r">
          <MDBCard className="cascading-admin-card">
            <div className="admin-up">
              <h2 icon="chart-line" style={cardStyle}>Mymensingh</h2>
              <div>
                <h4 style={divStyle}>
          ...
          <MDBCard className="cascading-admin-card">
            <div className="admin-up">
              <h2 icon="chart-line" style={cardStyle}>Rajshahi</h2>
              <div>
                <h4 style={divStyle}>
        ...
        <MDBCol xl="3" md="6" className="mb-r">
          <MDBCard className="cascading-admin-card">
            <div className="admin-up">
              <h2 icon="chart-pie" style={cardStyle}>Sylhet</h2>
              <div>
                <h4 style={divStyle}>
          ...
          <MDBCard className="cascading-admin-card">
            <div className="admin-up">
              <h2 icon="chart-pie" style={cardStyle}>Khulna</h2>
              <div>
                <h4 style={divStyle}>
        ...
        <MDBCol xl="3" md="6" className="mb-r">
          <MDBCard className="cascading-admin-card">
            <div className="admin-up">
              <h2 icon="chart-pie" style={cardStyle}>Barishal</h2>
              <div>
                <h4 style={divStyle}>
          ...
          <MDBCard className="cascading-admin-card">
            <div className="admin-up">
              <h2 icon="chart-pie" style={cardStyle}>Chittagong</h2>
              <div>
                <h4 style={divStyle}>
