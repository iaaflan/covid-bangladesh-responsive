...
class ChartSection2 extends Component {
    ...
    const rajshahiDivision =
      ["Bogura", "Jaipurhat", "Naogaon", "Natore", "Chapainawabganj", "Pabna", "Rajshahi", "Sirajganj"];
        ...
        const dataDoughnut = {
            labels: ["Dhaka", "Mymensingh", "Sylhet", "Rangpur", "Rajshahi","Chittagong","Barishal", "Khulna"],
            datasets: [{
                // API CALL
                data: [this.getDataByArray(dhakaDivision), this.getDataByArray(mymensinghDivision), this.getDataByArray(sylhetDivision),
                     this.getDataByArray(rangpurDivision), this.getDataByArray(rajshahiDivision),this.getDataByArray(chittagongDivision),
                     this.getDataByArray(barishalDivision), this.getDataByArray(khulnaDivision)],
                backgroundColor: ["#F7464A", "#46BFBD", "#FDB45C", "#949FB1", "#4D5360","#1121C1","#7721C1","#BB7A5E"],
                hoverBackgroundColor: ["#FF5A5E", "#5AD3D1", "#FFC870", "#A8B3C5", "#616774","#4421C1","#9921C1","#FFAA5E"]
            }]
        };
                        ...
                        <MDBTable hover>
                            ...
                            <MDBTableBody>
                                <tr>
                                    ...
                                    <td>{this.getDataByArray(dhakaDivision)}</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Rangpur Division</td>
                                    <td>{this.getDataByArray(rangpurDivision)}</td>

                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Rajshahi Division</td>
                                    <td>{this.getDataByArray(rajshahiDivision)}</td>

                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>Mymensingh Division</td>
                                    <td>{this.getDataByArray(mymensinghDivision)}</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>Sylhet Division</td>
                                    <td>{this.getDataByArray(sylhetDivision)}</td>

                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>Khulna Division</td>
                                    <td>{this.getDataByArray(khulnaDivision)}</td>

                                </tr>
                                <tr>
                                    <td>7</td>
                                    <td>Barishal Division</td>
                                    <td>{this.getDataByArray(barishalDivision)}</td>
                                </tr>
                                <tr>
                                    <td>8</td>
                                    <td>Chittagong Division</td>
                                    <td>{this.getDataByArray(chittagongDivision)}</td>
                                </tr>
                            </MDBTableBody>
                        </MDBTable>
                    </MDBCard>
